<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['pharmacy:cart:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['pharmacy:cart:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="cartList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户账户" align="center" prop="userId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="用户账户" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入用户账户" />
        </el-form-item>
        <el-form-item label="商品ID" prop="goodsId">
...
<script>
import { listCart, getCart, delCart, addCart, updateCart, exportCart } from "@/api/pharmacy/cart";
