 ...
 */
@RestController
@RequestMapping("/pharmacy/userinfo")
public class UserInfoController extends BaseController
{
     ...
     * 查询用户信息列表
     */
    @PreAuthorize("@ss.hasPermi('pharmacy:userinfo:list')")
    @GetMapping("/list")
     ...
     * 导出用户信息列表
     */
    @PreAuthorize("@ss.hasPermi('pharmacy:userinfo:export')")
     ...
     * 获取用户信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('pharmacy:userinfo:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增用户信息
     */
    @PreAuthorize("@ss.hasPermi('pharmacy:userinfo:add')")
     ...
     * 修改用户信息
     */
    @PreAuthorize("@ss.hasPermi('pharmacy:userinfo:edit')")
     ...
     * 删除用户信息
     */
    @PreAuthorize("@ss.hasPermi('pharmacy:userinfo:remove')")
