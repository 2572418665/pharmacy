    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['pharmacy:news:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['pharmacy:news:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listNews, getNews, delNews, addNews, updateNews, exportNews } from "@/api/pharmacy/news";
