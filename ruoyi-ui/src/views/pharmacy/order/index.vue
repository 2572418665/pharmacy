<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="收货方式" prop="receivingMethod">
        <el-input
          v-model="queryParams.receivingMethod"
          placeholder="请输入收货方式"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="自提码" prop="code">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['pharmacy:order:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['pharmacy:order:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['pharmacy:order:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="应付金额" align="center" prop="payable" />
      <el-table-column label="实付金额" align="center" prop="amount" />
      <el-table-column label="收货方式" align="center" prop="receivingMethod" />
      <el-table-column label="收货地址" align="center" prop="receivingAddress" />
      <el-table-column label="联系电话" align="center" prop="tel" />
      <el-table-column label="自提码" align="center" prop="code" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="应付金额" prop="payable">
          <el-input v-model="form.payable" placeholder="请输入应付金额" />
        </el-form-item>
        <el-form-item label="实付金额" prop="amount">
          <el-input v-model="form.amount" placeholder="请输入实付金额" />
        </el-form-item>
        <el-form-item label="收货方式" prop="receivingMethod">
          <el-input v-model="form.receivingMethod" placeholder="请输入收货方式" />
        </el-form-item>
        <el-form-item label="收货地址" prop="receivingAddress">
        ...
        <el-form-item label="自提码" prop="code">
          <el-input v-model="form.code" placeholder="请输入自提码" />
        </el-form-item>
        <el-form-item label="状态" prop="state">
...
<script>
import { listOrder, getOrder, delOrder, addOrder, updateOrder, exportOrder } from "@/api/pharmacy/order";
